# Object Detection via background subtraction and color filtering
...
def get_blobs(img_mask):
  ...
  # If mask value at [y,x] is 1, call expand_nr on copy of image mask and coordinate (y,x), giving a third argument of an empty list to populate with blob_coords.
        if mask_copy[(y, x)] == 1:
          blob_coords = expand_nr(mask_copy, (y, x), [])
...
def main():
  ...
  # Examples:
  add_color_range_to_detect([0,0,200], [100,75,255]) # Detect red
  add_color_range_to_detect([50,100,0], [135,255,110]) # Detect green
  add_color_range_to_detect([80,0,0], [255,150,100]) # Detect blue
  add_color_range_to_detect([0,200,250], [50,255,255]) # Detect yellow
